...
CT_NAME = 'UMU-Proton'
CT_LAUNCHERS = ['pixlproton']
CT_DESCRIPTION = {'en': QCoreApplication.instance().translate('ctmod_00umuproton', '''Steam compatibility tool for running Windows games with improvements over Valve's default Proton.<br/><br/>''')}


class CtInstaller(QObject):

    BUFFER_SIZE = 65536
    CT_URL = 'https://api.github.com/repos/Open-Wine-Components/umu-proton/releases'
    CT_INFO_URL = 'https://github.com/Open-Wine-Components/umu-proton/releases/tag/'
